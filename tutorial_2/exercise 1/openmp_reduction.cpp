		    ...
		    )
{
	...
	para_time_result = get_ToD_diff_time(time);	
	speedup = double(seq_time_result / para_time_result);
	eff = double(speedup / (double)num_thread);
