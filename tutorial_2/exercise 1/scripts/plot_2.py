...
file3_data = np.loadtxt('./generated_data/log_c_eff_vs_prblm_sz.txt')
file4_data = np.loadtxt('./generated_data/log_c_speedup_vs_prblm_sz.txt')
...
pyp.savefig("./generated_plots/weak_scaling_c_time_eff_speedup_VS_size.png")
