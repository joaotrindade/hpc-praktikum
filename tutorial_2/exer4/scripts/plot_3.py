...
file1_data = np.loadtxt('./generated_data/log_openmp_eff_vs_threads.txt')
file2_data = np.loadtxt('./generated_data/log_time_vs_threads.txt')
file3_data = np.loadtxt('./generated_data/log_time_vs_threads.txt')
...
pyp.legend([p1[0],p2[0],p3[0],p4[0],p5[0]], ['Efficiency', 'Computation time', 'Speedup','Ideal speedup', 'Ideal Efficiency'], 'best', numpoints=1)

pyp.savefig("./generated_plots/sacaling_time_eff_speedup_VS_threads.png")
