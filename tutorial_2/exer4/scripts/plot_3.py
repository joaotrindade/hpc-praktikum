...
#file2_data = np.loadtxt('./generated_data/log_openmp_time_vs_threads.txt')
file3_data = np.loadtxt('./generated_data/log_openmp_speedup_vs_threads.txt')
...
pyp.legend([p1[0],p3[0],p5[0]], ['Efficiency', 'Speedup', 'Ideal Efficiency'], 'best', numpoints=1)

pyp.savefig("./generated_plots/12.png")
