...
#Plot between x : Number of threads, y: computatinal time (Weak OpenMP)
...
file2_data = np.loadtxt('log_time_vs_threads.txt')
...
pylab.title('Weak Scaling: computation time vs number of threads')
...
pyp.savefig("./generated_plots/sacaling_time_VS_threads.png")
